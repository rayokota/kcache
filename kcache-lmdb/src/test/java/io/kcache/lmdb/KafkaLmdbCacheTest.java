...
public class KafkaLmdbCacheTest extends KafkaCacheTest {

    private static final Logger log = LoggerFactory.getLogger(KafkaLmdbCacheTest.class);
    ...
    protected Cache<String, String> createAndInitKafkaCacheInstance(String bootstrapServers) {
        Cache<String, String> lmdbCache = new LmdbCache<>(topic, dir.getRoot().toString(), Serdes.String(), Serdes.String());
