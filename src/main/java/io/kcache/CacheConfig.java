...
public class CacheConfig extends AbstractConfig {
    ...
    public static final String DEFAULT_KAFKASTORE_GROUP_ID = "kafkastore";
    /**
    ...
    public static ConfigDef baseConfigDef() {
        ...
        return new ConfigDef()
            ...
            .define(KAFKASTORE_GROUP_ID_CONFIG, ConfigDef.Type.STRING, DEFAULT_KAFKASTORE_GROUP_ID,
    ...
    public CacheConfig(ConfigDef configDef, Properties props) {
